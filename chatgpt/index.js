...
function isRelevantRequest(url2) {
  ...
  if (!url2.startsWith("https://freegpt.one")) {
    return false;
  }
  if (
...
async function browserPostEventStream(url2, accessToken, body, timeoutMs) {
  ...
  const origMessageId =
    (_b =
      (_a = body == null ? void 0 : body.messages) == null ? void 0 : _a[0]) ==
    null
      ? void 0
      : _b.id;
  let messageId =
    (_d =
      (_c = body == null ? void 0 : body.messages) == null ? void 0 : _c[0]) ==
    null
      ? void 0
      : _d.id;
  let response = "";
      ...
      async function onMessage(data) {
        ...
        try {
          ...
          const partialResponse =
            (_d2 =
              (_c2 =
                (_b2 = convoResponseEvent.message) == null
                  ? void 0
                  : _b2.content) == null
                ? void 0
                : _c2.parts) == null
    ...
    return {
      error: {
        ...
        statusCode:
          err.statusCode ||
          err.status ||
          ((_e = err.response) == null ? void 0 : _e.statusCode),
        statusText:
          err.statusText ||
          ((_f = err.response) == null ? void 0 : _f.statusText),
      },
      conversationId,
      messageId,
    };
...
`
  ...
  function getDOMException(errorMessage) {
    return globalThis.DOMException === void 0
        ...
        () => {
          ...
          const timeoutError =
            message instanceof Error
              ? message
              : new TimeoutError2(errorMessage);
...
var ChatGPTAPI = class extends AChatGPTAPI {
  constructor(opts) {
    ...
    const {
      ...
      clearanceToken,
      markdown = true,
      apiBaseUrl = "https://freegpt.one",
      backendApiBaseUrl = "https://freegpt.one/backend-api",
        ...
        onMessage: (data) => {
          ...
          try {
            ...
            if (message2) {
              let text =
                (_c =
                  (_b = message2 == null ? void 0 : message2.content) == null
                    ? void 0
                    : _b.parts) == null
                  ? void 0
                  : _c[0];
...
async function getOpenAIAuth({
  ...
  try {
    ...
    if (hasRecaptchaPlugin) {
      ...
      if (
        (_a = captchas == null ? void 0 : captchas.filtered) == null
          ? void 0
          : _a.length
      ) {
    ...
    const authInfo = {
      userAgent,
      clearanceToken:
        (_c = cookies["cf_clearance"]) == null ? void 0 : _c.value,
      sessionToken:
        (_d = cookies["__Secure-next-auth.session-token"]) == null
          ? void 0
          : _d.value,
    };
    return authInfo;
  ...
  if (captcha) {
    ...
    do {
      try {
        ...
        const value =
          (_a = await captcha2.evaluate((el) => el.value)) == null
            ? void 0
            : _a.trim();
...
// src/chatgpt-api-browser.ts
var CHAT_PAGE_URL = "https://freegpt.one/";
var ChatGPTAPIBrowser = class extends AChatGPTAPI {
  ...
  async initSession() {
    ...
    const verifyCf = async () => {
      if ((await this._page.title()).includes("moment")) {
        try {
          await this._page.waitForSelector(".hcaptcha-box");
        } catch (e) {
        ...
        const frame = this._page
          .frames()
          .find((frame) => frame.url().includes("cloudflare"));
        if (frame) {
  ...
  async resetSession() {
    ...
    try {
      ...
      console.log(`ChatGPT refreshSession success`);
    } catch (err) {
      console.error(`ChatGPT resetSession error`, err.toString());
    }
  }
  async refreshSession() {
    ...
    console.log(`ChatGPT refreshSession...`);
    try {
      if (!this._minimize) {
          ...
          (response2) => {
            ...
            if (cookie == null ? void 0 : cookie.includes("cf_clearance=")) {
              const cfClearance =
                (_c =
                  (_b =
                    (_a = cookie.split("cf_clearance=")) == null
                      ? void 0
                      : _a[1]) == null
                    ? void 0
                    : _b.split(";")) == null
      ...
      console.error(`ChatGPT error refreshing session`, err.toString());
    } finally {
      this._isRefreshing = false;
    }
  }
  ...
  async sendMessage(message, opts = {}) {
    ...
    const url2 = `https://freegpt.one/backend-api/conversation`;
    const body = {
      action,
      messages: [
        {
    ...
    do {
      ...
      try {
        ...
        if (++numTries >= 2) {
          ...
          error.statusCode =
            (_a = err.response) == null ? void 0 : _a.statusCode;
          error.statusText =
            (_b = err.response) == null ? void 0 : _b.statusText;
          cleanup();
          throw error;
        }
  ...
  get isChatPage() {
    ...
    try {
      const url2 =
        (_a = this._page) == null ? void 0 : _a.url().replace(/\/$/, "");
